...
// Super owner is stored in MongoDB settings so it applies across all servers.
...
// Banned users stored in db.settings.bannedUsers (MongoDB) — persists & syncs across servers
